...
class EmployeeTraining(models.Model):
    ...
    def print_event(self):
        ...
        return self.env.ref('employee_training.print_pack_certificates').report_action(self, data=data)
    ...
    def confirm_send_mail(self):
        ...
        try:
            template_id = ir_model_data.get_object_reference('employee_training', 'orientation_training_mailer')[1]
        except ValueError:
            template_id = False
        try:
