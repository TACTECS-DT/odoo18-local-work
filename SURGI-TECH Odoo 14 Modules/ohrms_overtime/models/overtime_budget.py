...
class DepartmentBudget(models.Model):
    ...
    peremployee=fields.Boolean(string="Budget Per Employee",default=False,help="في حال التفعيل يتم احتساب ميزانية الوقت الاضافي علي اساس الموظف ثم الادارة , و في حال عدم التفعيل يتم احتساب ميزانية الوقت الاضافي علي اساس الادارة فقط")
    amount = fields.Float()
