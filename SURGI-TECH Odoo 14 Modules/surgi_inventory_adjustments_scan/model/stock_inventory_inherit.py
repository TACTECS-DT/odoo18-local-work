...
class stock_inventory_inherit(models.Model):
    ...
    location_ids = fields.Many2many(
        ...
        domain="[]")
    block = fields.Boolean(string="Lock")
    tages_ids = fields.Many2many('tages.inveintory', 'name', string='Tage',store=True)
    ...
    def get_stock_inventory_scan_data(self, active_id):
        ...
        returnData = {"data": data, "datalower": datalower, "products": productsData, 'productsCodeData': {},
                      'res': res,
...
class tages_inveintory_scan(models.Model):
    _name = 'tages.inveintory'
    ...
    # _sql_constraints = [
    #     ('color_uniq', 'unique (color)', "Tag Color already exists !"),
    # ]