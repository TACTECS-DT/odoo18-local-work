...
class wizard_back_to_warehouse(models.TransientModel):
    ...
    def do_transfer_selected_lines(self):
        ...
        if operation.is_operation_freeze:
            raise Warning("you can not move items in frezed operation !")
    ...
    scan_option = fields.Selection([('withscan', 'With scan'), ('withoutscan', 'Without Scan')], required=True,default='withscan')
