...
class GradeGrade(models.Model):
    ...
    travel_expenses_allow = fields.Float('Travel Exp Allow.', tracking=True,
                                         digits=dp.get_precision('Payroll'))
    travel_allow_int_f = fields.Float('Travel Allow internal Fixed', tracking=True,
                                      digits=dp.get_precision('Payroll'))
...
class RankRank(models.Model):
    ...
    # total_salary = fields.Float('Salary',tracking=True,digits=dp.get_precision('Payroll'))
